package com.kleber.risk.decision.service;

import com.google.common.base.Strings;
import com.kleber.risk.decision.api.CreditRequestDecisionV1;
import com.kleber.risk.decision.api.CreditRequestV1;
import com.klarna.risk.decision.domain.*;
import com.kleber.risk.decision.domain.CreditDecision;
import com.kleber.risk.decision.domain.CreditDecisionMaker;
import com.kleber.risk.decision.domain.CustomerDebt;
...
public class CreditDecisionServiceV1 {
    ...
    public CreditRequestDecisionV1 handleCreditRequestV1(CreditRequestV1 creditRequestV1) {
        ...
        CreditDecision creditDecision = creditDecisionMaker.makeCreditDecision(creditRequestV1.getPurchaseAmount(), customerDebt.getDebtAmount(),customerDebt.getDebtLimit());
        ...
        //creditHistoryRepository.lookupTransactions("");
